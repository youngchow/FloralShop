...
public class AdminCategoryServlet extends BaseServlet {
	...
	private static final long serialVersionUID = -2780087245667075544L;
	...
	public String findAll(HttpServletRequest req, HttpServletResponse resp)
		...
		return "f:/admin/admin/category/list.jsp";
	}
	/**
	 * 添加一级分类
	 * @param req
	...
	public String editParentPre(HttpServletRequest req, HttpServletResponse resp)
		...
		return "f:/admin/admin/category/edit.jsp";
	}
	/**
	 * 修改一级分类：第二步
	 * @param req
	...
	public String addChildPre(HttpServletRequest req, HttpServletResponse resp)
		...
		return "f:/admin/admin/category/add2.jsp";
	}
	/**
	 * 添加二级分类，第二步
	 * @param req
	...
	public String editChildPre(HttpServletRequest req, HttpServletResponse resp)
		...
		return "f:/admin/admin/category/edit2.jsp";
	}
	/**
	 * 修改二级分类：第二步
	 * @param req
